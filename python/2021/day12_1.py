...
def findEnd(cave, caves_visited, caves_parent, end_cave):
    ...
    for neighbor in cave.neighbors:
        ...
        elif neighbor in caves_visited:
            print("\tAlready visited")
            continue
        else:
            print("\tSearching neighbors")
            path = findEnd(neighbor, caves_visited, caves_parent, end_cave)
            if not path == []:
                for p in path:
                    paths.append(p)
            else:
...
for n in start_cave.neighbors:
    ...
    pathsFound = findEnd(n, caves_visited, caves_parent, end_cave)
